...
public class UserScreen {
    public final static String Start_SCREEN = "반갑습니다!  [1]로그인  [2]회원가입  [3]종료";
    ...
    public final static String CLIENT_SCREEN = "[1]음식점 조회  [2]음식 주문  [3]주문 취소  [4]주문 내역 죄회  [5]리뷰등록  [6]개인정보 수정  [7]로그아웃";
    public final static String OWNER_SCREEN = "[1]음식점 등록  [2]옵션 등록  [3]메뉴 등록  [4]리뷰 조회  [5]답글 등록  [6]통계  [7]로그아웃";
